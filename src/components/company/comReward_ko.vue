				...
				<div class="company-personal-wrap cpmpany-shadow" style="padding: 30px 30px 0 30px !important;">
				  	<div class="reward-manage">
					    <div class="clearfix  reward-header">
					    	...
					    	<div class="fl">
							      <p style="color:#4a4c52;font-size: 14px;">보상금 계획을 발표하여 더 많은 화이트 해커가 당신의 프로젝트에 대한 지속적인 검사와 결함을 발견하도록 격려함으로써 보안 이니셔티브를 파악할 수 있도록 도와드립니다. 계획 내용은 언제든지 변경할 수 있습니다.</p><br />
		            			  <router-link to="/Bounty" target="_blank">[About Bounty]</router-link>
					    	</div>
            			    <div class="fr" style="text-align: right;">
            				  	<router-link :to="{path:'/companyTwoCons',query:{company:mycompany}}" target="_blank"><el-button class="btnshadow wrapBtnw" style="border: 0;">미리보기</el-button></router-link>
            			  		<el-button  class="btnshadow wrapBtn" style="margin-left: 10px;"  type="primary" @click="edit_CZdjfbbtn"  :disabled="isDisable">게시하기</el-button><br />
			...
			<el-card  shadow="hover" class="rewardcon" style="margin-top: 30px;background: #ffffff;padding: 40px 20px 20px 0;"> 
					    	<el-tabs :tab-position="tabPosition"   v-model="activeName"  @tab-click="handleClick">
							    <el-tab-pane label="1.RewardPlan" name="first">
						    		<div>
						    			<div class="rewardConhead">결함 보상금은 심각성에 기초함.평판참고 <router-link to="/rewardReference" target="_blank">[참조 템플릿]</router-link></div>
							    ...
							    <el-tab-pane label="2.TestRange" v-if="this.dataCsfw==''" disabled name="second">
							    	<div class="rewardConhead">보안 요원이 어떤 도메인/응용에 대해 테스트할 수 있는지; 어떤 도메인/응용에 대해 테스트할 수 없는지를 지정하세요<router-link to="/rewardReference" target="_blank">[참조 템플릿]</router-link></div>
							    	<div class="reward-manage-item clearfix">
							    		<div class="reward-plan-edit">
							    ...
							    <el-tab-pane label="3.VulnerabilityRating" v-if="!this.dataVulSer " disabled name="third">
							    	<div class="rewardConhead">결함의 심각성. 평판참고<router-link to="/rewardReference"  target="_blank">[참조 템플릿]</router-link></div>
							    	<div class="reward-manage-item clearfix">
									    <div class="reward-plan-edit">
									     		<p>Low</p>
							    ...
							    <el-tab-pane label="4.Precautions" v-if="!this.dataVulSer"  disabled name="fourth">
							    	<div class="rewardConhead">Supplementary explanation<span style="color:#F00;font-size: 14px;color: #b4bdc2;">（선택）</span>평판참고  <router-link to="/rewardReference" target="_blank">[참조 템플릿]</router-link></div>
							        <div class="reward-manage-item clearfix">
								        <div class="reward-plan-edit">
			...
			<!-- 余额不足 -->
				<el-dialog
					 ...
					 <div class="common-pop-up">
					 	<h3>결함 보상금 계획에 가입하기 전에 보증금을 저장해야 합니다.</h3>
					 	 ...
					 	 보증금 잔액：<span>{{$store.state.CSuser.user.balance}}</span>Ether，잔액이 부족합니다 &nbsp;&nbsp;<el-button  type="primary" class='fr btnshadow wrapBtn' @click="dialogVisibleCZbtn"> 보증금 충전하기 </el-button><br>
					      <p></p>
					    </div>
				</el-dialog>
				<!--充值弹窗-->
						      ...
						      <p class="apply-title" style="margin-bottom: 30px;">PaymentDeposit
								  ...
								  <div slot="content">
								  		<div>
									        ...
									        <p class="apply-info-text">• 보증금은 DVP에 예치된 결함 보상금입니다.</p>
									        <p class="apply-info-text">• 보상금 계획을 게시하기 위해 저장해야 하는 보증금은 단일 심한 결함의 최고 인센티브 값보다 낮아서는 안 됩니다.</p>
									        <p class="apply-info-text">• 보증금은 수시 환불이 가능합니다.</p>
									        <p class="apply-info-text">• 충전 과정에 문제가 생기면 이메일로 DVP 고객서비스에 연락하세요.</p>
				...
				<el-dialog
					 ...
					 <div class="common-pop-up ac">
					 	<div class="ac">보상금을 게시하기 전에 기업 프로필과 로고(LOGO)와 같은 정보를 보완하십시오.</div>
					 	<router-link to="/combox/company/comMember"><el-button  type="primary" style="margin-top: 20px;" class="btnshadow wrapBtn">관련 정보 보완하기</el-button></router-link>
					      <p></p>
					    </div>
				</el-dialog>
				<!-- 发布成功 -->
				...
				<el-dialog
					 ...
					 <div class="common-pop-up ac">
					 	...
					 	<el-button  type="primary" style="margin-top: 20px;" class="btnshadow wrapBtn"  @click="otherRewardBtn" >계속 수정하기</el-button>
					      <p></p>
					    </div>
				</el-dialog>
				<!-- 身份审核 -->
				<el-dialog
					  ...
					  width="400px">
					 <div class="common-pop-up ac">
					 	<div class="ac">DVP 회원기입이 완료되었습니다. 신원 심사를 기다리십시오.</div>
					      <p></p>
					    </div>
				</el-dialog>
		  </div>
