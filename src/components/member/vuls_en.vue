	...
	<el-container>
			...
			<div style="margin-top: -60px">
				 <div class="itemvuls" style="padding-left: 145px !important;">
  			    	...
  			    	<el-badge :value="myVulslddtDatanum[2]" v-if="!myVulslddtDatanum[2]==0"  class="item item2" style='margin-left: 242px !important;'></el-badge>
...
<script>
	...
	export default {
		...
		components:{vulsCons,vulsCons2},
		 data() {
	        return {
	        	mess:'<el-badge :value="myVulslddtData.length" class="item"><div>To Be Verified</div></el-badge>',
	        	total:0,//默认数据总数
                pagesize: 0,//每页的数据条数
	        	...
	        	activeName: 'first',
	         	...
	         	myVulslddtDataD:[],
	         	myVulslddtDataW:[],
	         	options1: [{ id: 'all', label: 'all' },{ id: 0, label: 'Being Audit' }, {  id: 1, label: 'Approved'  }, {  id: 2, label: 'Verification Failed: Additional Information Required'  }, {  id: 3, label: 'Verification Failed'  },{id:5,label:'Supplement Information to Be Verified'}],
			    options2: [{ id: 'all', label: 'all' },{   id: 0, label: 'Not Confirmed' }, { id: 1,label: 'Claimed by the Vendor'},{ id: 2, label: 'Vendor Failed to Claim the Loophole' },{ id: 3, label: 'Claimed by DVP' }],
			    value2:'all',
			    value1:'all',
			    myVulslddtDatanum:[],
                loading:false,
