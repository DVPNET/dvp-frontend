	...
	<el-row class="bounty-vendor" :gutter="20">
		...
		>
			...
			>
				...
				<el-tab-pane label="Bug Bounty" name="first" class="vul_state">
					<bountyVenCon
				...
				<!--未认领漏洞-->
				<el-tab-pane label="Exchange" name="second" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<!--修复漏洞-->
				<el-tab-pane label="Public chain" name="four" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<!--已认领漏洞-->
				<el-tab-pane label="Token" name="three" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<!--精华漏洞-->
				<el-tab-pane label="Mine pool" name="five" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<!--公开漏洞-->
				<el-tab-pane label="Wallets" name="six" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<el-tab-pane label="Other" name="eight" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
