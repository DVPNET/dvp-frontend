	...
	<el-row class="bounty-vendor" :gutter="20">
		...
		>
			...
			<el-tabs
				...
				class="lddt_wrap bounty-pagecons"
			>
				<div
					class="search"
				...
				<!--未认领漏洞-->
				<el-tab-pane label="交易所" name="second" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<!--修复漏洞-->
				<el-tab-pane label="公链" name="four" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<!--已认领漏洞-->
				<el-tab-pane label="代币" name="three" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<!--精华漏洞-->
				<el-tab-pane label="矿池" name="five" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<!--公开漏洞-->
				<el-tab-pane label="钱包" name="six" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
				...
				<el-tab-pane label="其它" name="eight" class="vul_state">
					<bountyVenCon
						:bountyDatas="bountyData"
						v-loading="loading"
					></bountyVenCon>
