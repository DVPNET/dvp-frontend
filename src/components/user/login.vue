    ...
    <div class="home-wrap">
        ...
        <div class="logAreg_boxbg" v-show="!comEmailinfo">
	        ...
	        <div class="logAreg_box  wrapshadow" style="position: relative;" v-show="!passEmailinfo">
	        	...
	        	<h2 v-show="loginShowBMZ">作为<span class="comcolor">白帽子</span>登录<a @click="Role" class="fr Roleswitch">{{Roleswitch}}</a></h2>
	        	<h2 v-show="loginShowCS">作为<span class="comcolor">厂商</span>登录<a @click="Role" class="fr Roleswitch">{{Roleswitch}}</a></h2>
				...
				<div v-show="loginShowBMZ">
	 				<el-form :model="DVP_BMZLog" v-enterToNext="true" ref="DVP_BMZLog" label-width="100px" class="demo-ruleForm" status-icon  :rules="DVP_BMZLogS" :label-position="labelPosition">
                        ...
                        <el-form-item label="" prop="pass">
						    <el-input type="password" v-model="DVP_BMZLog.pass"  autocomplete="off"  placeholder="输入密码"></el-input>
						</el-form-item>
                ...
                <div v-show="loginShowCS">
                    <el-form :model="DVP_CSLog" v-enterToNext="true" ref="DVP_CSLog" label-width="100px" class="demo-ruleForm" status-icon :rules="DVP_CSLogS" :label-position="labelPosition" >
                        ...
                        <el-form-item label="" prop="pass">
                            <el-input type="password" v-model="DVP_CSLog.pass" autocomplete="off" placeholder="输入密码"></el-input>
                        </el-form-item>
                        <el-form-item label="" prop="yzm" class="yzmbox">
                        ...
                        <el-form-item>
                        	<p class="cp" @click="respass" style="padding: 0 15px;color: #2196f3;">忘记密码？</p>
				...
				<div v-show="resSucess" class='ac'>
					...
					<el-button type="primary" class="loginWCBtn" @click="BMZuserBtn" style="display: none;"><b>{{count}}</b>秒后自动进入个人中心</el-button>
				</div>
				<div v-show="resCSSucess" class='ac'>
					<img src="/static/image/logAres/sucessIcon.png" style="margin-top: 30px;" alt="" /><br />
					<p style="font-size: 16px;margin: 30px 0;">{{$t('message.loginSuccess')}}</p>
					<el-button type="primary" class="loginWCBtn" @click="CSuserBtn" style="display: none;"><b>{{count}}</b>秒后自动进入个人中心</el-button>
				</div>
	        </div>
	        <!--邮箱信息-->
	    ...
	    <el-dialog
		  ...
		  width="432px">
				<p class="ac">您浏览器尚未安装Metamask，无法登录。</p>
				<a href="https://chrome.google.com/webstore/detail/nkbihfbeogaeaoehlefnkodbefgpgknn" target="_blank"><el-button class="nextBtn btnshadow"  style="background: #2196f3 !important;color: #ffffff !important;" >点击下载Metamask</el-button></a>
		</el-dialog>
    </div>
</template>
