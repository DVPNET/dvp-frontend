module.exports = {
    ...
    DeFi: {
        ...
        DeFiProjectSettled: 'Vendors Registration',
        ContractPage: 'Contract Contrast',
        DeFiZone: 'DeFi Zone',
        Project: 'I\'m a Vendor',
        AddBounty: 'Join the Bounty Program to provide safeguards for value creation',
        ProjectSettled: 'DeFi Vendors Registration',
        ClaimLoopholes: 'Claim the Vulnerability',
        WhiteHat: 'I\'m a white hat',
        EarnCommission: 'Vulnerability Mining - Earn rewards by detecting vulnerabilities',
        ContractDetection: 'Smart Contract Audit',
        VulnerabilitySubmission: 'Vulnerability Submission',
        Absenteeism: 'I\'m a freshman farmer',
        Prospecting: 'Contract Audit on new farms before farming to protect your assets',
        SmartContract: 'Smart Contract Contrast Tool',
        LightningLoanAlert: 'Flash Loan Risk Warning',
    },

    Detection: {
        AddressPlace: 'Enter Smart Contract Address (Optional)',
        PleaseChoose: 'Select',
        DetectNow: 'Detect Now',
        SolidityCode: 'Contract Source Code (Solidity)',
        Vulnerability: 'Vulnerability',
        VulnerabilityLocation: 'Vulnerability Identify:',
        VulnerabilityDescription: 'Vulnerability Description:',
        VulnerabilityType: 'Vulnerability Type:',
        CorrectCode: 'Please enter correct contract code',
        UnavailableCode: 'Contract Unavailable',
        GeneralSafety: 'No regular vulnerabilities detected'
    },


    ComReward: {
        PostBounty: 'Publish reward plan, and encourage more white hats to detect more loopholes in your projects. Plan can be changed without notice.',
        AboutBounty: 'About Bounty',
        Preview: 'Preview',
        Release: 'Publish',
        LatestUpdate: "Latest Update",
        Reward1: '1.RewardPlan',
        JudgmentReference: 'Loophole reward based on severity.Grading reference ',
        ReferenceTemplate: 'Reference template',
        NextStep: 'Next',
        Reward2: '2.TestRange',
        JudgmentReference2: 'Specify which domain/applications you can test for security personnel; which domain/applications cannot be tested',
        PleaseContent: 'Please enter the content',
        Previous: 'Back',
        JudgmentReference3: 'Specify which domain/applications you can test for security personnel; which domain/applications cannot be tested',
        JudgmentReference4: 'Reference template',
        Reward3: '3.VulnerabilityRating',
        LowRisk: 'Low',
        InDanger: 'Mid',
        HighRisk: 'High',
        Serious: 'Critical',
        JudgmentReference5: 'Defined severity of loopholes. Grading reference',
        RewardThree: '3.VulnerabilityRating',
        Supplement: 'Supplementary explanation',
        NotRequired: 'Optional',
        JudgmentReferenceText: 'Grading reference ',
        MattersNeedingAttention: '4.Precautions',
        CarryOut: 'Carry out',
        Tips: 'Tips',
        StorageGuarantee: 'You need to store the deposit before you join the Bug Bounty.',
        ...
        InsufficientBalance: 'Balance not enough',
        RemainingDeposit: 'Account balance：',
        DepositRecharge: 'Make deposit',
        PayGuarantee: 'PaymentDeposit',
        GuaranteeMoneyDescription: 'About the Security Deposit',
        GuaranteeMoneyDescription1: 'The security deposit is the sum of cryptocurrencies held in DVP for bounty rewards.',
        GuaranteeMoneyDescription2: 'You need to deposit NO less than the bounty rewards for one critical loophole before publishing a bounty program.',
        GuaranteeMoneyDescription3: 'You can withdraw from the security deposit at any time.',
        GuaranteeMoneyDescription4: 'If you have problem depositing funds, please contact DVP customer support by email.',
        PaymentAddress: 'Payment address',
        ScanQRCodeToPay: 'Open wallet, scan the code to pay',
        PleaseEnter: 'Please enter the TxHash',
        PaymentCompleted: 'Payment Completed',
        DVPWillBe: 'DVP will complete audit in 15 minutes, please wait...',
        Determine: 'Confirm',
        TopUpSuccessfully: 'Payment Completed',
        SecurityReview: 'You have successfully submitted your transaction number, please wait for the security deposit review.',
        AuditFailure: 'VerificationFailed',
        CompanyProfiles: 'Before publishing reward plan, please complete company introduction and logo, etc.',
        PerfectInformation: 'Complete required information',
        TheBugBounty: 'Publishing loophole reward plan success',
        LookOver: "Check again",
        ContinueEditing: 'Continue to edit',
        SuccessfullyRegistered: 'You have registered DVP account successfully, please wait for ID check.',
